 ...
 * @since 1.0.0
 */
function timetable_wp_demo_add_caps() {

    $role = get_role('administrator');
    $role->add_cap('timetable_wp_demo_config');

    $role = get_role('editor');
    $role->add_cap('timetable_wp_demo_config');
}

add_action( 'admin_init', 'timetable_wp_demo_add_caps' );
 ...
 * @since 1.0.0
 */
function timetable_wp_demo_options_page() {

    add_submenu_page(
        'mixd-wp-plugins',              // $parent_slug
        'Mixd Plugins: Demo Plugin',    // $page_title
        'Demo Plugin',                  // $menu_title
        'timetable_wp_demo_config',          // $capability
        'timetable_wp_demo_options',         // $menu_slug
        'timetable_wp_demo_options'          // $callback
    );

}

add_action( 'admin_menu', 'timetable_wp_demo_options_page' );
 ...
 * @since 1.0.0
 */
function timetable_wp_demo_options() {
